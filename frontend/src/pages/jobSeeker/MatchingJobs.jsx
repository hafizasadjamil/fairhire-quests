...
//                       <button className="bg-red-100 text-red-600 text-sm px-3 py-1 rounded-full hover:bg-red-200">
//                         Cancel Application
//                       </button>
//                       <button className="bg-yellow-300 text-black text-sm px-3 py-1 rounded-full hover:bg-yellow-400">
//                         Save Job
//                       </button>
//                       <Link
//                         to={`/jobs/${job._id}`}
